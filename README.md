...
### Promo Video
Each group is to submit one promo video one minute in length. If your game is exceptional, I will use this video in a YouTube playlist and portions of it on social media. Please ensure you use first names only and **don't mention any personal information**. This video must show and prove all requirements from the "**End product**" section of the mark breakdown. No other video or code submitted will apply to that section.
...
**Please note:** The code explanation video is supposed to be an explanation of your code and **how** it works - not just what it does. You must use technical language to show me you know what these concepts are. This is not a video where you only say "here is a function I wrote". Why did you choose to use a list? Why did you use a function? Use technical language without sounding like you are reading a script. See the sub-topics under the requirements for key words you should know and use.
